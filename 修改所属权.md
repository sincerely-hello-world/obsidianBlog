...
```bash
SUBSYSTEM=="gpio*", PROGRAM="/bin/sh -c 'chown  root:gpio /sys/class/gpio && chmod ug+rw  /sys/class/gpio; chown -R root:gpio /sys/devices/virtual/gpio && chmod -R 770 /sys/devices/virtual/gpio'"
```
