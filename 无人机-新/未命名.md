...
static bool Land_g(float v)
{
    ...
    if (soft_land_phase == 1) {  // 软停止阶段
		...
		if( soft_land_count < 200 ) { PWM_PulseWidthReduce_All(20); target_width -= 20; ++soft_land_count;}
		else                        { PWM_PulseWidthReduce_All(10);  target_width -= 10; }	
