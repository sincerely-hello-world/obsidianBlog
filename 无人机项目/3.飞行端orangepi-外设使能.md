...
sudo chmod -R ug+rw     /sys/class/gpio /sys/class/gpio/export /sys/class/gpio/unexport

sudo chown -R root:gpio /sys/class/gpio*/active_low /sys%p/edge /sys%p/direction /sys%p/value #/sys%p/uevent
sudo chmod -R ug+rw     /sys%p/active_low /sys%p/edge /sys%p/direction /sys%p/value #/sys%p/uevent
