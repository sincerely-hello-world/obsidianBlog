...
```bash
chown -R root:gpio /sys/class/gpio /sys/class/gpio/export /sys/class/gpio/unexport 
chmod -R ug+rw  /sys/class/gpio /sys/class/gpio/export /sys/class/gpio/unexport

/bin/chown root:gpio /sys%p/active_low /sys%p/edge /sys%p/direction /sys%p/value
/bin/chmod ug+rw /sys%p/active_low /sys%p/edge /sys%p/direction /sys%p/value
