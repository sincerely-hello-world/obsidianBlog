...
+  位于uav_car_unit\camera.py 摄像头节点的发布者**camera__data_topic** （不是UDP话题），负责程序间通信，传图给 uav_car\image_processor.py这个rknn图像处理订阅者 
+ 位于 uav_car\image_processor.py节点的**udp_info_topic**， 其创建了一个订阅者sub_udp_info，订阅


+ 位于 uav_car\image_processor.py的
