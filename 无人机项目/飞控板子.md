...
+ 地面站**发布全部飞行路径节点**的话题 **fly_path_topic**， 由飞行端navigator.py节点的**fly_path_sub**订阅，即为self.fly_path_sub = self.create_subscription( Float64MultiArray, "fly_path_topic", self.**fly_path_callback**, 5)
```python
