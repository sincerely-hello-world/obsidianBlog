...
+  位于飞行端 uav_car_unit\camera.py 节点的话题**camera_data_topic** 发布者pub_camera（不是UDP话题发布者），负责读取摄像头信息，转发给其他节点 uav_car\image_processor.py节点下的rknn图像处理订阅者 ，回调**sub_camera_callback**：
