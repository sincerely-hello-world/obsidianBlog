...
+  位于uav_car_unit\camera.py 摄像头节点的发布者**camera__data_topic** （不是UDP话题），负责程序间通信，传图给 uav_car\image_processor.py节点下的rknn图像处理订阅者 ，回调sub_camera_callback，进行动物识别，send_location->
