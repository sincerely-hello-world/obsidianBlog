...
ExecStop=/etc/uav_car.local stop
TimeoutSec=0 
StandardOutput=tty 
RemainAfterExit=yes 
...
Type=forking
ExecStartPre=/bin/sleep 3 
ExecStart=/home/orangepi/Desktop/UAV_CAR__Test/uav_start.sh start
ExecStop=/home/orangepi/Desktop/UAV_CAR__Test/uav_start.sh stop
TimeoutSec=0 
StandardOutput=tty 
RemainAfterExit=yes 
