...
```bash
这里下载
wget -P ~/my  https://github.com/rockchip-linux/rknn-toolkit2/tree/master/rknpu2/runtime/Linux/librknn_api/aarch64

pip3 install -y ~/my/rknn_toolkit_lite2-x.y.z-cp38-cp38-linux_aarch64.whl 
