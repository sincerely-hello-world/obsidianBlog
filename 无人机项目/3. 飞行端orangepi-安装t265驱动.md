...
https://zhuanlan.zhihu.com/p/441905002 参考此博客指导，可以在下载好的https://github.com/IntelRealSense/librealsense.git 包下面找到python示例程序：
...
+ 或是将 /usr/lib/python3.8/site-packages/pyrealsense2 目录下的动态库
