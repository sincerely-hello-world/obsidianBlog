...
# 我们要使用 pwm3-m0 pwm14-m1 。对应寄存器度地址分别是：fd8b0030
-----------------------------
...
```bash
gpiochip0 - 32 lines:
    line   0:      "PIN_1"       unused   input  active-high
    line   1:      "GPIO0_A1"    unused   input  active-high   ← 这就是 A1！
    line   2:      "GPIO0_A2"    unused   input  active-high
    ...
    line   8:      "GPIO0_B0"    unused   input  active-high
    line   9:      "GPIO0_B1"    unused   input  active-high   ← 这就是 B1！
```
...
KERNEL=="pwmchip*/pwm*",SUBSYSTEM=="pwm",  ACTION=="add", RUN+="/bin/sh -c 'chmod -R g+rw /sys/class/pwm/%k/'"
...
lrwxrwxrwx 1 root root 0 Dec  8 20:25 /sys/class/pwm/pwmchip0 -> ../../devices/platform/fd8b0020.pwm/pwm/pwmchip0
lrwxrwxrwx 1 root root 0 Dec  8 20:25 /sys/class/pwm/pwmchip1 -> ../../devices/platform/fd8b0030.pwm/pwm/pwmchip1
lrwxrwxrwx 1 root root 0 Dec  8 20:25 /sys/class/pwm/pwmchip2 -> ../../devices/platform/febd0020.pwm/pwm/pwmchip2
lrwxrwxrwx 1 root root 0 Dec  8 20:25 /sys/class/pwm/pwmchip3 -> ../../devices/platform/febf0020.pwm/pwm/pwmchip3
```
