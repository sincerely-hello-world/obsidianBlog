...
# svn export https://github.com/airockchip/rknn-toolkit2/trunk/rknpu2/runtime/Linux/librknn_api/aarch64
...
if [ ! -e /usr/lib/librknnrt.so.backup ]; then
    sudo cp /usr/lib/librknnrt.so /usr/lib/librknnrt.so.backup
    echo "已创建备份：/usr/lib/librknnrt.so.backup"
else
    echo "备份已存在，跳过。"
fi
