...
下载镜像，烧录到SD卡，
```
orangepi@orangepi5b:~/Desktop$ echo "Ubuntu 版本: $(lsb_release -d | cut -f2)"
Ubuntu 版本: Ubuntu 20.04.6 LTS
orangepi@orangepi5b:~/Desktop$ echo "发行代号: $(lsb_release -c | cut -f2)"
发行代号: focal
orangepi@orangepi5b:~/Desktop$ echo "系统架构: $(uname -m)"
系统架构: aarch64
orangepi@orangepi5b:~/Desktop$ echo "内核版本: $(uname -r)"
内核版本: 6.1.43-rockchip-rk3588
...
# 更新 librknnrt.so 动态库，否则无法加载v6版本模型
